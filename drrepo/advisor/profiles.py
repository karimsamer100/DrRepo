...
_SUPPORTED_PROFILES = {
    ...
    "production_api": {
        "profile_version": PROFILE_VERSION,
        "profile_id": "production_api",
        "display_name": "Production API",
        "description": "Best for API services where test reliability, security, configuration, and deployment readiness matter most.",
        "primary_user_goal": "Make the API reliable, secure, configurable, and credible enough for production review.",
        "high_priority_categories": ["security", "tests", "coverage", "configuration", "logging", "health_checks", "dependency_locking", "deployment_readiness"],
        "medium_priority_categories": ["documentation", "maintainability", "structure"],
        "lower_priority_categories": ["presentation", "optional_tooling"],
        "always_high_priority_flags": ["failing_tests", "high_security_risk", "exposed_secrets"],
        "deprioritize_when_low_risk": ["presentation", "optional_tooling"],
        "advisor_tone": "Direct and operationally focused, emphasizing API reliability and risk reduction.",
    },
    "ai_ml_project": {
        "profile_version": PROFILE_VERSION,
        "profile_id": "ai_ml_project",
        "display_name": "AI/ML Project",
        "description": "Best for machine-learning, inference, RAG, or experiment repositories where reproducibility and limitations matter.",
        "primary_user_goal": "Make the model, data, metrics, environment, and inference/training workflow understandable and reproducible.",
        "high_priority_categories": ["reproducibility", "documentation", "dependencies", "testing", "metrics", "data_documentation", "limitations"],
        "medium_priority_categories": ["security", "maintainability", "structure"],
        "lower_priority_categories": ["presentation", "advanced_deployment"],
        "always_high_priority_flags": ["failing_tests", "high_security_risk"],
        "deprioritize_when_low_risk": ["advanced_deployment", "optional_tooling"],
        "advisor_tone": "Precise and reproducibility-focused, emphasizing evidence, datasets, metrics, and limitations.",
    },
